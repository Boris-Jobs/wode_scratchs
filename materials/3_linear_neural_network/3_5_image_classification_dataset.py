...
if __name__ == '__main__':
    ...
    # mnist_train的每一个元素是一个元组，比如mnist_train[0]就是一个图像和一个标签构成的元组
    # print('mnist_train的第一个元素（图像和标签构成的元组）：', mnist_train[0])
    print('每张图的大小：', mnist_train[0][0].shape, '\n')
    print('mnist_train每个元素的类型：', type(mnist_train[0]))
    print('获取mnist_train的类：', mnist_train.classes)
    print('mnist_train标签的前10个', [mnist_train[i][1] for i in range(10)])
